...
The GameSparks platform allows you to manage your NoSQL data via a REST interface, this is useful to allow you to control your game data via your own software. This REST API provides the same features found in the GameSparks Developer Portal [NoSQL Explorer](/developer-portal/nosql).

The REST endpoint requires Basic Auth, see [here](https://docs.gamesparks.net/documentation/rest-api/rest-api) for details.
