...
<td width="80%">To set up a team type, head to the Teams tab in the configurator and click the 'Add new' button. You'll be prompted with a screen to configure your Team type, in this screen you'll find:
...
Once you're happy with your configuration. That's all you have to do to create a Team type for your players to use. More details on team type creation and management, click [here](https://docs.gamesparks.net/developer-portal/teams "Teams").</td>

<td>[![](https://docs.gamesparks.net/wp-content/uploads/2016/01/team-300x157.png)](https://docs.gamesparks.net/wp-content/uploads/2016/01/team.png)</td>
...
<pre class="lang:as decode:true">Request default:
{
...
<td width="80%">Once the Team has been created other players can join it by simply using the 'JoinTeam' request and passing in the teamID or OwnerID.Once the response comes back it will include the data for the owner, team details and members which will now be the owner and the player that sent the join request.</td>
