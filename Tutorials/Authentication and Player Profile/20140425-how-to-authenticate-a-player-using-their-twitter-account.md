...
![](img/AuthTwit/3.png)
 ...
 In a separate tab/window head over to [the GameSparks developer portal](https://portal.gamesparks.net) and click the overview of your game. Click the 'Edit' icon and enter the API Key and API Secret from the Twitter portal into the fields "Twitter App ID" and "Twitter App Secret" and then click "Save".
  ...
  In a separate tab/window head over to the [Integrations](https://docs.gamesparks.net/developer-portal/integrations) page, click to edit the Twitter Integration enter the API Key and API Secret from the Twitter portal into the fields "Twitter App ID" and "Twitter App Secret" and then click "Save".
...
```
Now head on over to [Social Capabilities](/?p=2139) to see how you can make the most of social integration.
