title: ChallengeJoinedMessage
link: https://docs.gamesparks.net/documentation/message-api/multiplayer-message-api/challengejoinedmessage
author: gabriel.page
description: 
post_id: 2318
...
post_name: challengejoinedmessage
status: publish
post_type: post
