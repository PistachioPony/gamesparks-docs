title: ChallengeLapsedMessage
link: https://docs.gamesparks.net/documentation/message-api/multiplayer-message-api/challengelapsedmessage
author: GameSparks
description: 
post_id: 6150
...
post_name: challengelapsedmessage
status: publish
post_type: post
