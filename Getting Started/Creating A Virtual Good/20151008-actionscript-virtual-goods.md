title: ActionScript Virtual Goods
link: https://docs.gamesparks.net/tutorials/actionscript-virtual-goods
author: omar.albadry
description:
post_id: 9216
created: 2015/10/08 16:07:52
created_gmt: 2015/10/08 15:07:52
comment_status: closed
post_name: actionscript-virtual-goods
status: publish
post_type: post
...
Once you have created [Virtual Goods](/tutorials/creating-a-virtual-good) on the Portal, you can now incorporate them in your game. This tutorial will show you how to buy and consume goods using a shop interface. *Creating a 'Grant Currency' Event*
...
In the Event *Cloud Code* create a variable that holds the amount being passed in the Event through the _'CASH'_ *attribute, *and name it '_money_'. Next get the Player object using *Spark.getPlayer()* and credit their *currency1* with the '_money_' value.
![r](img\AS\2.png)
 

## *Creating the Buy and Consume functions*

Create a function which will log a *buy R**equest* when called by using *BuyVirtualGoods* request. The *BuyVirtualGoods* request needs a *currency* type, a *quantity* and the *Short code* for the item to be purchased.
