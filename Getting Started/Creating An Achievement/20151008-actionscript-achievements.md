title: ActionScript Achievements
link: https://docs.gamesparks.net/tutorials/actionscript-achievements
author: omar.albadry
description:
post_id: 9204
created: 2015/10/08 14:57:58
created_gmt: 2015/10/08 13:57:58
comment_status: closed
post_name: actionscript-achievements
status: publish
post_type: post
...
After making an Event that awards your Player an Achievement using Cloud Code in the Portal, you can now incorporate them into your game. This tutorial will show you how to award the Player an Achievement and a way to check the Achievements a Player has earned in-game. *Setting up the Account Details Request and Earning an Achievement*
...
Before you award the authenticated Player an *A**chievement* you'll have to give them the ability to check the *Achievements* that they've earned. To do that you must request *account details* using the *createAccountDetailsRequest* using the *requestBuilder*.
